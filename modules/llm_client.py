...
class LLMClient:
    def __init__(self):
        ...
        self.gemini_last_resort = "models/gemini-2.0-flash-exp"
    ...
    async def generate_text(
        ...
        if "gemini-2.0-flash-exp" not in models_to_try:
    ...
    async def _execute_request(
        ...
        - Gemini SDK: plain names like "gemini-2.0-flash-exp" or "models/gemini-2.0-flash-exp".
        """
        ...
        if is_openrouter_style and self.openrouter_client:
            ...
            return await self._call_gemini_sdk(
                full_model_path, prompt, system_instruction, temperature, max_tokens
            )
    ...
    async def _call_gemini_sdk(
        ...
        try:
            ...
            if "404" in err_msg or "not found" in err_msg.lower():
                logger.warning(
                    f"Gemini model '{clean_name}' not found. Falling back to models/gemini-2.0-flash..."
                )
